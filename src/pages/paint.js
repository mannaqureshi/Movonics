...
export class PaintForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Request_Type: "",
  ...
  submit = async () => {
    ...
    const valid = Object.keys(FormKeys).every(key => {
      if (Request_Type == Conditions.C && key == FormKeys.Paint_Job_Description)
        return true;
      if (
                ...
                <DatePicker
                  onChange={(m, v) => {
                    const date = m
                      ...
                      .replace(" ", "T");
                    this.genericHandler(FormKeys.Paint_Survey_Date_Time, date);
                  }}
                  onOk={value => {
                    const date = value
                      .format("YYYY-MM-DD HH:MM:SS")
            ...
            {this.state.Request_Type != Conditions.C && (
              <div className="form-field">
                ...
                <Select
                  ...
                  placeholder="select"
                  onChange={value => {
                    this.genericHandler(FormKeys.Paint_Job_Description, value);
                  }}
                >
